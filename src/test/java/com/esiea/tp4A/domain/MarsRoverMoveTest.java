...
class MarsRoverMoveTest {
    ...
    void initial_position_elsewhere() {
        MarsRover nmarsRover=new MarsRoverMove();
        MarsRover marsRover = nmarsRover.initialize(Position.of(32, 14, Direction.SOUTH));
        Position newPosition = marsRover.move("");
    ...
    void front_move_north() {
        MarsRover nmarsRover=new MarsRoverMove();
        MarsRover marsRover = nmarsRover.initialize(Position.of(32, 14, Direction.NORTH));
    ...
    void front_move_east() {
        MarsRover nmarsRover=new MarsRoverMove();
        MarsRover marsRover = nmarsRover.initialize(Position.of(32, 14, Direction.EAST));
        Position newPosition = marsRover.move("f");
    ...
    void front_move_west() {
        MarsRover nmarsRover=new MarsRoverMove();
        MarsRover marsRover = nmarsRover.initialize(Position.of(32, 14, Direction.WEST));
        Position newPosition = marsRover.move("f");
